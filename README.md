...
- 🌱 Learning DevOps & container orchestration, and getting Django-ready for the **Transcendence** project
- 🛠️ Past builds include a full **IRC server** in C++ and a Unix shell (**Minishell**) in C, both from the 42 core curriculum
- 💬 Ask me about C/C++, low-level systems programming, or 42 Paris life
