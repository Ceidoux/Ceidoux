...
<p align="center">
  ...
  <a href="https://www.linkedin.com/in/seydou-mestre/" target="_blank">
...
```
 _  _   ____    seydou@42paris
| || | |___ \   --------------------
| || |_  __) |  Name: Seydou Mestre
|__   _|/ __/   Role: Software Engineering student
   | | | (___   Currently: Inception-of-Things (K3s · Vagrant · Argo CD)
   |_| |_____|  Learning: Django, on the way to Transcendence
                Shipped: IRC server (C++), Minishell (C)
                Ask me about: C/C++, low-level systems, 42 Paris life
```
